...
const Header = () => {
    ...
    const handleLogout = () => {
        ...
        // You might also want to clear any auth-related state here
                    ...
                    <div className='row'>
                        ...
                        <div className='col-6'>
                            <p className='text-end text-white mb-0'>
                                Hotline:
                                <a className='text-white' href='tel:1-800-000-0000'>1-800-000-0000</a>
                            </p>
                        </div>
                    </div>
                </div>
                                    ...
                                    <Link to={authState?.user == null ? '/login' : '#'} className="d-flex align-items-center gap-10 text-white">
                                        ...
                                        {!authState?.user ? (
                                            ...
                                            <>
                                                ...
                                                <button style={{textDecoration: "none"}} onClick={handleLogout} className="btn btn-link text-white p-0 ms-2">
                                                    Logout
                                                </button>
                                            </>
                                        )}
